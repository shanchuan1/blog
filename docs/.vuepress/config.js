        ...
        * */
        [
            ...
            // "vuepress-plugin-player",
            {
                ...
                // songIds: ['475479888','167654','25638340'],
                //网易云歌单
                playlist: '7082462754',
                // playlist: '1415641976',
                showPlaylist: true,
                ...
                //本地歌曲
                // 可搜索可解析网站音乐的链接地址  http://www.ihaoge.net/song/252722.html
                //   外链地址转换的网站   https://link.hhtjim.com/
                localSongs: {
                    coverUrl: '/avatar.png',
                    songs: [
                        {
                            path: '/song/在你的身边.mp3',
                            songName: '在你的身边',
                            cover: '	http://imge.kugou.com/stdmusic/400/20210630/20210630181811872340.jpg'
                        },
                        // {
                        ...
                        {
                            path: '/song/yellow.mp3',
                            songName: 'yellow',
                            cover: 'http://imgcdn.170hi.com/star/starheads/180/7/97/3437943365.jpg'
                        },
                        {
                            path: '/song/旅行.mp3',
                            songName: '旅行',
                            cover: 'https://p1.music.126.net/IqMLsL5GfpK1f0ioiBdrPg==/69269232550733.jpg?param=130y130'
                        },
                        {
                            path: 'https://link.hhtjim.com/163/5146554.mp3',
                            songName: 'Right Now (Na Na Na)',
                            cover: 'http://p2.music.126.net/bsA7MQRJhRe_tQs38knaQA==/109951166176187930.jpg?param=130y130'
                        },
                        {
                        ...
                        {
                            path: 'https://link.hhtjim.com/163/1388433823.mp3',
                            songName: 'Bleeding Love',
                            cover: 'http://p2.music.126.net/46ryEbXvr8RIKLBC6g1-bA==/109951166927061061.jpg?param=130y130'
                        },
                        {
                            path: 'https://link.hhtjim.com/163/28718313.mp3',
                            songName: 'The Way I Still Love You',
                            cover: 'http://p1.music.126.net/JyPsd_g00M-4mqXLLtHncw==/5984641790343690.jpg?param=130y130'
                        },
                        {
                            path: 'https://link.hhtjim.com/163/33418570.mp3',
                            songName: 'Best of 2012: Payphone/Call Me Maybe/Wide Awake/Starship/We Are Young',
                            cover: 'http://p1.music.126.net/1IzMedyRibuL0f4aH3B13Q==/109951164855810320.jpg?param=130y130'
                        },
                        {
                            path: 'https://link.hhtjim.com/163/26524701.mp3',
                            songName: 'My Heart Will Go On',
                            cover: 'http://p2.music.126.net/vjmBbza1Msi3CSowzI9zhw==/4404643580873409.jpg?param=130y130'
                        },
                        {
                            path: 'http://ip.h5.rh01.sycdn.kuwo.cn/7e43c87a8adc6cf69286825a87dda109/62fb4891/resource/n1/79/60/2695427084.mp3',
                            songName: 'See You Again',
                            cover: 'https://img2.kuwo.cn/star/albumcover/500/21/94/3252914005.jpg'
                        },
                        {
                            path: 'http://ip.h5.ra01.sycdn.kuwo.cn/69945696393d97b9b1b6daa0b8aa1959/62fb4a6f/resource/n2/128/66/79/1768346066.mp3',
                            songName: '好想大声说爱你',
                            cover: 'http://p2.music.126.net/y2VjUoaJ3LiQpQihfuuKTw==/109951163655513518.jpg?param=130y130'
                        },
                        {
                            path: 'https://link.hhtjim.com/163/27495025.mp3',
                            songName: '直到世界尽头',
                            cover: 'http://p2.music.126.net/ss5Rm0q7UIV1cMvUid-tbw==/5727356069142637.jpg?param=130y130'
                        },
                    ]
                }
            }
    ...
    head: [
        ...
        [
            "link",
            {
                rel: 'stylesheet',
                type: 'text/css',
                href: '//at.alicdn.com/t/c/font_3590301_mds2k5vj4n.css'
            }
        ],
        /*[
            "link",
    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //这是首页文章列表懒加载图片
        homePageLazyLoadingImg: '/shanchuan1.jpg',
        ...
        keyword: "vuepress主题,vuepress theme,生活琐事,,简约博客,博客主题,",
        ...
        * */
        ...
        //页脚信息，支持HTML，这是一个数组
        footer: [
            "Copyright © by shanchuan All Rights Reserved.",
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: '7/7/2022 12:22:00',
        ...
        * */
        ...
        //侧边栏一句话描述
        sidebarDesc: 'Life is Fucking Moive',
