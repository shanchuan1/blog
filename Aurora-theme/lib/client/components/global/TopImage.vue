...
<template>
  <div class="sidebar-single-enter-animate page-top" v-if="isShowTopImg" id="page-top">
    <div class="top-mask" :style="setBackgroundUrl1"></div>
...
export default {
  ...
  computed: {
    ...
    // 修改页面顶部图片
    setBackgroundUrl1() {
      let imgPath1 = "https://images.pexels.com/photos/55821/pyrenees-mountains-snow-zenith-55821.jpeg "
      // return "background-image: url(" + imgPath + ");"
      return "background-image: url(" + imgPath1 + ");"
    },
